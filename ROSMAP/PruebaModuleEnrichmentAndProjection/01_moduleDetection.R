...
g_cntrl = readRDS(file = "E:/DataROSMAPNetwork/DataOnlyWithSymbol/relevanceNetworks/network_earlyOnset_with_info.rds")
g_cases = readRDS(file = "E:/DataROSMAPNetwork/DataOnlyWithSymbol/relevanceNetworks/network_lateOnset_with_info.rds")
