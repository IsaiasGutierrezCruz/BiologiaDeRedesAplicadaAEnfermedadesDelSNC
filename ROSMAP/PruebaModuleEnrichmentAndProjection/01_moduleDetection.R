...
g_cntrl = readRDS(file = "E:/DataROSMAPNetwork/Data/network_earlyOnset_with_info.rds")
g_cases = readRDS(file = "E:/DataROSMAPNetwork/Data/network_lateOnset_with_info.rds")
